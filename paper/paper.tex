...
\subsection{Instrumenting Programs for Predicate Abstraction}
	...
	% The next step involves collecting static information about the program that will help us apply our inference rules. Namely, we will populate the environment $\Gamma$ such that 
